...
import { AccountBalanceMessage, OrderBookData, OrderCancelMessage, OrderCreateMessage, TickerData, TradeData, WebSocketMessage } from "./types";
 ...
 * @param data - The WebSocket message data.
 */
export function isOrderbookMessage(data: WebSocketMessage): data is OrderBookData {
 ...
 */
export function isAccountBalanceMessage(data: WebSocketMessage): data is AccountBalanceMessage {
 ...
 */
export function isOrderCreateMessage(data: WebSocketMessage): data is OrderCreateMessage {
 ...
 */
export function isOrderCancelMessage(data: WebSocketMessage): data is OrderCancelMessage {
